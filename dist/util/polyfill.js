    ...
    !(function () {
        ...
        function o() {
            ...
            if (!('scrollBehavior' in t.documentElement.style && !0 !== o.__forceSmoothScrollPolyfill__)) {
                ...
                }, s = o.performance && o.performance.now ? o.performance.now.bind(o.performance) : Date.now, c = ((l = o.navigator.userAgent), new RegExp(['MSIE ', 'Trident/', 'Edge/'].join('|')).test(l) ? 1 : 0);
                (o.scroll = o.scrollTo =
                    function () {
